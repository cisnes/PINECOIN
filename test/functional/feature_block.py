...
class FullBlockTest(PineCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure pinecoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure pinecoind isn't accepting b28
        ...
        # pinecoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the pinecoin code has custom code which does so);
