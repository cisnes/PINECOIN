...
"""Verify that starting pinecoin with -h works as expected."""

from test_framework.test_framework import PineCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(PineCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pinecoin with -h for help text")
        ...
        self.log.info("Start pinecoin with -version for version information")
        ...
        self.log.info("Start pinecoind with -fakearg to make sure it does not start")
