...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PineCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pinecoin: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/pinecoin"), tr("&About %1").arg(PACKAGE_NAME), this);
    ...
    toggleHideAction = new QAction(platformStyle->TextColorIcon(":/icons/pinecoin"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PineCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PineCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a pinecoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible PineCoin command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to PineCoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
