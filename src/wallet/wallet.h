...
#ifndef PINECOIN_WALLET_WALLET_H
#define PINECOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! pinecoin from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The PineCoin Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this pinecoin node, and set to 0 for transactions that were created
...
#endif // PINECOIN_WALLET_WALLET_H
