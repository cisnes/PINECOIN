...
#ifndef PINECOIN_COINS_H
#define PINECOIN_COINS_H
...
public:
    ...
    /**
     * Amount of pinecoins coming in to a transaction
 ...
 * between pinecoind, and pinecoin-qt and non-server tools.
 *
