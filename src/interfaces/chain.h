...
#ifndef PINECOIN_INTERFACES_CHAIN_H
#define PINECOIN_INTERFACES_CHAIN_H
...
//! internal workings of the pinecoin node, and not being very convenient to use.
...
#endif // PINECOIN_INTERFACES_CHAIN_H
