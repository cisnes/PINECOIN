...
(define* (make-pinecoin-cross-toolchain target
                                  #:key
...
desirable for building PineCoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-pinecoin-cross-toolchain "i686-linux-gnu")
       (make-pinecoin-cross-toolchain "x86_64-linux-gnu")
       (make-pinecoin-cross-toolchain "aarch64-linux-gnu")
       (make-pinecoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-pinecoin-cross-toolchain "riscv64-linux-gnu"
