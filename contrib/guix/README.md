# Bootstrappable PineCoin Core Builds

This directory contains the files necessary to perform bootstrappable PineCoin
Core builds.
...
- 24GB of free disk space on the partition that the PineCoin Core git repository
  resides in
...
For a PineCoin Core depends development environment, simply invoke
...
From the top of a clean PineCoin Core repository:
...
To use dongcarl's substitute server for PineCoin Core builds after having
